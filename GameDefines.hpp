...
// GObjects
#define GObjects_Offset		(uintptr_t)0x024890F8
// GNames
#define GNames_Offset		(uintptr_t)0x024890B0
...
extern TArray<class UObject*>* GObjects = nullptr;
extern TArray<struct FNameEntry*>* GNames = nullptr;
